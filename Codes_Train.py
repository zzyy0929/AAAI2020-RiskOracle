...
loss =1.2*tf.reduce_mean(tf.square(task_01_o1 - y_true1))+0.8*tf.reduce_mean(tf.square(task_02_o2 - y_true2))+tf.reduce_mean(tf.square(task_03_o3 - y_true3))
#+cross_entropy
...
with tf.Session() as sess:
    ...
    for i in range(epoch):
        ...
        if i%1==0:
            ...
            #print(Acc1,Acc2)
            np.save('GCN_results_07/task_1_0813_'+str(Dim_o3)+'_9L_384_'+str(i)+'.npy',pred_Y1) 
            np.save('GCN_results_07/task_3_0813_'+str(Dim_o3)+'_9L_384_'+str(i)+'.npy',pred_Y3) 
